!(function (e, t) {
	...
	var e = (function (H) {
			...
			function N(e, t, n, i) {
				...
				if (!i && (x(t), (t = t || E), T)) {
					...
					if (
						...
						if (((c = e), (u = t), 1 === d && (ie.test(e) || ne.test(e)))) {
							for (
								((u = (ue.test(e) && me(t.parentNode)) || t) === t &&
									f.scope) ||
									((s = t.getAttribute("id"))
										? (s = s.replace(de, M))
				...
				function (e) {
					...
					return (
						e != E &&
							...
							(f.getElementsByClassName = S.test(E.getElementsByClassName)),
							...
							(i = []),
							(p = []),
							(f.qsa = S.test(E.querySelectorAll)) &&
								(L(function (e) {
									var t;
			...
			(N.attr = function (e, t) {
				...
				var n = _.attrHandle[t.toLowerCase()],
					n = n && X.call(_.attrHandle, t.toLowerCase()) ? n(e, t, !T) : void 0;
				return void 0 !== n
					? n
					: f.attributes || !T
					? e.getAttribute(t)
			...
			((_ = N.selectors =
				{
					...
					pseudos: {
						...
						lang: O(function (n) {
							return (
								oe.test(n || "") || N.error("unsupported lang: " + n),
				...
				for (
					var i,
						...
						u = [
							function (e, t, n) {
								e =
									(!o && (n || t !== w)) || ((i = t).nodeType ? l : c)(e, t, n);
								return (i = null), e;
							},
						];
					a < r;
			...
			return (
				...
				(h = N.tokenize =
					function (e, t) {
						...
						return t ? s.length : s ? N.error(e) : Q(e, a).slice(0);
					}),
				(B = N.compile =
					function (e, t) {
						var n,
					...
					function (e, t, n, i) {
						...
						if (((n = n || []), 1 === u.length)) {
							if (
								...
								if (!(t = (_.find.ID(s.matches[0].replace(j, d), t) || [])[0]))
									return n;
				...
				(f.sortStable = C.split("").sort(U).join("") === C),
	...
	(T.filter = function (e, t, n) {
		...
		T.fn.extend({
			...
			is: function (e) {
				return !!J(this, "string" == typeof e && K.test(e) ? T(e) : e || [], !1)
					.length;
			},
		});
	var Z,
		...
		te =
			(((T.fn.init = function (e, t, n) {
				...
				return (
					(n = E.getElementById(i[2])) && ((this[0] = n), (this.length = 1)),
					this
				);
			}).prototype = T.fn),
			(Z = T(E)),
				...
				T.fn[i] = function (e, t) {
					...
					return (
						(t = "Until" !== i.slice(-5) ? e : t) &&
							...
							(n = T.filter(t, n)),
						1 < this.length &&
							(ne[i] || T.uniqueSort(n), te.test(i) && n.reverse()),
						this.pushStack(n)
					);
				};
			}
	...
	function d(e, t, n, i, r, o, s) {
		var a = 0,
			l = e.length,
			c = null == n;
		if ("object" === p(n)) for (a in ((r = !0), n)) d(e, t, a, n[a], !0, o, s);
		else if (
			void 0 !== i &&
			((r = !0),
			y(i) || (s = !0),
	...
	T.extend({
		...
		T.fn.extend({
			data: function (n, e) {
				...
				if (
					this.length &&
					((r = c.get(o)), 1 === o.nodeType && !_.get(o, "hasDataAttrs"))
				) {
					for (t = s.length; t--; )
						s[t] &&
					  ...
					  "" === i.style.display &&
							...
							(l[c] =
								...
								(a = _e[s]) ||
									...
									(_e[s] = a = "none" === a ? "block" : a)))))
					: "none" !== n && ((l[c] = "none"), _.set(i, "display", n)));
	...
	function Ae(e, t, n, i, r) {
		...
		for (u.textContent = "", f = 0; (o = d[f++]); )
			...
			else if (((l = A(o)), (s = j(u.appendChild(o), "script")), l && Te(s), n))
				for (c = 0; (o = s[c++]); ) Ee.test(o.type || "") && n.push(o);
		return u;
	}
	var ke = /^([^.]*)(?:\.(.+)|)/;
	function s() {
	...
	function Ne(e, r, o) {
		o
			...
			: void 0 === _.get(e, r) && T.event.add(e, r, s);
	}
	(T.event = {
		global: {},
		...
		special: {
			...
			click: {
				setup: function (e) {
					e = this || e;
					return (
						we.test(e.type) && e.click && l(e, "input") && Ne(e, "click", s), !1
					);
				},
				trigger: function (e) {
					e = this || e;
					return (
						we.test(e.type) && e.click && l(e, "input") && Ne(e, "click"), !0
					);
				},
				_default: function (e) {
					e = e.target;
	...
	function N(n, i, r, o) {
		...
		var e,
			...
			h = i[0],
			p = y(h);
		if (p || (1 < d && "string" == typeof h && !m.checkClone && Oe.test(h)))
			return n.each(function (e) {
				var t = n.eq(e);
				p && (i[0] = h.call(this, e, t.html())), N(t, i, r, o);
			});
		if (
			d &&
			...
			for (a = (s = T.map(j(e, "script"), Ie)).length; u < d; u++)
				(l = e),
					u !== f &&
	...
	function qe(e, t, n) {
		for (var i, r = t ? T.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
			n || 1 !== i.nodeType || T.cleanData(j(i)),
				i.parentNode &&
					(n && A(i) && Te(j(i, "script")), i.parentNode.removeChild(i));
		return e;
	}
	T.extend({
		...
		clone: function (e, t, n) {
			...
			if (
				...
				for (s = j(u), i = 0, r = (o = j(e)).length; i < r; i++)
					(a = o[i]),
			...
			if (t)
				if (n)
					for (o = o || j(e), s = s || j(u), i = 0, r = o.length; i < r; i++)
						Me(o[i], s[i]);
				else Me(e, u);
			return 0 < (s = j(u, "script")).length && Te(s, !d && j(e, "script")), u;
		},
			...
			replaceWith: function () {
				...
				return N(
					...
					function (e) {
						...
						T.inArray(this, n) < 0 &&
							(T.cleanData(j(this)), t && t.replaceChild(e, this));
					},
					n
				);
			},
	...
	function Je() {
		...
		r &&
			...
			w.appendChild(Xe).appendChild(r),
	...
	function ct(e, t, n, i, r, o) {
		...
		for (; s < 4; s += 2)
			"margin" === n && (l += T.css(e, n + f[s], !0, r)),
				i
					? ("content" === n && (l -= T.css(e, "padding" + f[s], !0, r)),
					  "margin" !== n && (l -= T.css(e, "border" + f[s] + "Width", !0, r)))
	...
	function vt(e, t, n) {
		for (
			var i,
				r = (L.tweeners[t] || []).concat(L.tweeners["*"]),
				o = 0,
				s = r.length;
			o < s;
			o++
	...
	function L(r, e, t) {
		var n,
			...
			h = function () {
				...
				for (
					...
					p.tweens[n].run(t);
				return (
					f.notifyWith(r, [p, t, e]),
					t < 1 && i
						? e
						: (i || f.notifyWith(r, [p, 1, 0]), f.resolveWith(r, [p]), !1)
				);
			},
			p = f.promise({
				elem: r,
				...
				stop: function (e) {
					...
					return (
						e
							? (f.notifyWith(r, [p, 1, 0]), f.resolveWith(r, [p, e]))
							: f.rejectWith(r, [p, e]),
						this
					);
				},
		...
		for (; u < d; u++)
			if ((n = L.prefilters[u].call(p, r, g, p.opts)))
				return (
					y(n.stop) &&
	...
	(T.Animation = T.extend(L, {
		...
		tweener: function (e, t) {
			for (
				var n, i = 0, r = (e = y(e) ? ((t = e), ["*"]) : e.match(C)).length;
				i < r;
				i++
			)
				(n = e[i]),
				...
				if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f))
					...
					f))
						l ||
							...
							p && k([e], !0),
							d.done(function () {
								for (i in (p || k([e]), _.remove(e, "fxshow"), f))
									T.style(e, i, f[i]);
							})),
							(l = vt(p ? g[i] : 0, i, d)),
							i in g ||
	...
	T.fn.extend({
		...
		T.fn.extend({
			addClass: function (t) {
				...
				if ((e = xt(t)).length)
					for (; (n = this[a++]); )
						if (((s = I(n)), (i = 1 === n.nodeType && " " + P(s) + " "))) {
							for (o = 0; (r = e[o++]); )
								i.indexOf(" " + r + " ") < 0 && (i += r + " ");
							s !== (s = P(i)) && n.setAttribute("class", s);
						}
				return this;
			},
			...
			toggleClass: function (r, t) {
				...
				return "boolean" == typeof t && s
					...
					? this.each(function (e) {
							T(this).toggleClass(r.call(this, e, I(this), t), t);
					  })
					: this.each(function () {
							var e, t, n, i;
							if (s)
								for (t = 0, n = T(this), i = xt(r); (e = i[t++]); )
									n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
							else
								(void 0 !== r && "boolean" != o) ||
									((e = I(this)) && _.set(this, "__className__", e),
									this.setAttribute &&
										this.setAttribute(
											"class",
											(!e && !1 !== r && _.get(this, "__className__")) || ""
										));
					  });
			},
			hasClass: function (e) {
				for (var t, n = 0, i = " " + e + " "; (t = this[n++]); )
					if (1 === t.nodeType && -1 < (" " + P(I(t)) + " ").indexOf(i))
						return !0;
				return !1;
			},
		});
			...
			(T.extend(T.event, {
				trigger: function (e, t, n, i) {
					...
					if (
						...
						if (!i && !c.noBubble && !g(n)) {
							for (
								s = c.delegateType || f, Ct.test(s + f) || (p = p.parentNode);
								p;
								p = p.parentNode
							)
								d.push(p), (o = p);
						...
						return (
							...
							i ||
								...
								(a &&
									...
									((o = n[a]) && (n[a] = null),
									(T.event.triggered = f),
									e.isPropagationStopped() && u.addEventListener(f, Et),
									n[f](),
									e.isPropagationStopped() && u.removeEventListener(f, Et),
		...
		T.extend({
			...
			ajax: function (e, t) {
				...
				if (
					...
					if (((_.readyState = 1), h && m.trigger("ajaxSend", [_, p]), f))
						return _;
					p.async &&
						0 < p.timeout &&
	...
	var Vt = [],
		...
		Kt =
			...
			T.each(["top", "left"], function (e, n) {
				T.cssHooks[n] = Ge(m.pixelPosition, function (e, t) {
					if (t)
						return (t = Ke(e, n)), Ve.test(t) ? T(e).position()[n] + "px" : t;
				});
			}),
	...
	(function (t) {
		...
		var t = Object.create(null),
			r =
				...
				(a.migrateIsPatchEnabled = function (e) {
					return !t[e];
				}),
				i.console &&
					i.console.log &&
		...
		function s(e, t) {
			var n = i.console;
			!a.migrateIsPatchEnabled(e) ||
				(a.migrateDeduplicateWarnings && r[t]) ||
				((r[t] = !0),
				a.migrateWarnings.push(t + " [" + e + "]"),
				n &&
					n.warn &&
					!a.migrateMute &&
					(n.warn("JQMIGRATE: " + t), a.migrateTrace && n.trace && n.trace()));
		}
		...
		function o(e, t, n, i, r) {
			...
			e[t] = function () {
				return (
					r && s(i, r),
					(a.migrateIsPatchEnabled(i) ? n : o || a.noop).apply(this, arguments)
				);
			};
		}
		function l(e, t, n, i, r) {
			if (!r) throw new Error("No warning message provided");
			o(e, t, n, i, r);
		}
		function c(e, t, n, i) {
			o(e, t, n, i);
		...
		for (u in (c(
			...
			function (e) {
				...
				return (
					a.migrateIsPatchEnabled("selector-empty-id") &&
						"string" == typeof e &&
						"#" === e &&
						(s("selector-empty-id", "jQuery( '#' ) is not a valid selector"),
						(t[0] = [])),
					p.apply(this, t)
				);
			},
		...
		c(
			...
			function (t) {
				...
				if ("string" == typeof t && m.test(t))
					try {
						i.document.querySelector(t);
					} catch (e) {
						t = t.replace(v, function (e, t, n, i) {
							return "[" + t + n + '"' + i + '"]';
						});
						try {
							i.document.querySelector(t),
							...
							s(
								"selector-hash",
								"Attribute selector with '#' was not fixed: " + n[0]
							);
						}
					}
		...
		g))
			Object.prototype.hasOwnProperty.call(g, u) && (a.find[u] = g[u]);
		l(
			a.fn,
			"size",
			function () {
			...
			a.ajax &&
				...
				e("4.0.0") ||
					a.ajaxPrefilter("+json", function (e) {
						!1 !== e.jsonp &&
							(f.test(e.url) ||
								("string" == typeof e.data &&
									0 ===
		...
		a.swap &&
			...
			c(
				...
				function (e, t, n, i) {
					var r,
						o = {};
					for (r in (T ||
						s("swap", "jQuery.swap() is undocumented and deprecated"),
					t))
			...
			e("3.4.0") &&
				...
				(a.cssProps = new Proxy(a.cssProps || {}, {
					set: function () {
						return (
							s("cssProps", "jQuery.cssProps is deprecated"),
			...
			c(
				...
				function (e, t) {
					...
					return e && "object" == typeof e && !Array.isArray(e)
						...
						: ("number" == typeof t &&
								((n = t = x(e)),
								(C.test(n) && H.test(n[0].toUpperCase() + n.slice(1))) ||
									a.cssNumber[t] ||
									s(
										"css-number",
		...
		var k,
				...
				(c(
					...
					function (e, t, n) {
						...
						if (t && "object" == typeof t && 2 === arguments.length) {
							for (o in ((i = a.hasData(e) && P.call(this, e)), (r = {}), t))
								o !== x(o)
									? (s(
											"data-camelCase",
											"jQuery.data() always sets/gets camelCased names: " + o
									  ),
									  (i[o] = t[o]))
									: (r[o] = t[o]);
							return P.call(this, e, r), t;
						}
						return t &&
							"string" == typeof t &&
							t !== x(t) &&
							(i = a.hasData(e) && P.call(this, e)) &&
							t in i
							? (s(
									"data-camelCase",
				...
				a.fx &&
					...
					i.requestAnimationFrame &&
						Object.defineProperty(a.fx, "interval", {
							...
							get: function () {
								return (
									i.document.hidden || s("fx-interval", S),
									a.migrateIsPatchEnabled("fx-interval") && void 0 === k
										? 13
										: k
								);
							},
			...
			I =
					...
					function (e) {
						...
						if (i.length)
							for (
								s(
									"event-old-patch",
									"jQuery.event.props are deprecated and removed: " + i.join()
								);
								i.length;

							)
								a.event.addProp(i.pop());
						if (
							n &&
							!n._migrated_ &&
							((n._migrated_ = !0),
						...
						return (t = R.call(this, e)), n && n.filter ? n.filter(t, e) : t;
					},
					"event-old-patch"
				),
				c(
				...
				(a.event.special.ready = {
					setup: function () {
						this === i.document &&
							s("ready-event", "'ready' event is deprecated");
					},
				}),
				l(
					a.fn,
			...
			a.Deferred &&
				...
				c(
					...
					function (e) {
						...
						return (
							l(o, "pipe", t, "deferred-pipe", "deferred.pipe() is deprecated"),
							l(s, "pipe", t, "deferred-pipe", "deferred.pipe() is deprecated"),
							e && e.call(o, o),
							o
						);
					},
				...
				(a.Deferred.exceptionHook = O.exceptionHook)),
			a
		);
	}),
	(function (e, t) {
		...
		const l = (e) => {
			...
			U = (n, i, e = !0) => {
				if (e) {
					...
					let t = !1;
					const r = ({ target: e }) => {
						e === i && ((t = !0), i.removeEventListener(M, r), l(n));
					};
		...
		const v = {
				...
				off(s, a, e, t) {
					if ("string" == typeof a && s) {
						const [n, i, r] = oe(a, e, t),
							o = r !== a,
							l = ie(s);
						t = a.startsWith(".");
						if (void 0 !== i)
							return l && l[r] ? void ae(s, l, r, i, n ? e : null) : void 0;
						t &&
						...
						Object.keys(c).forEach((e) => {
							...
							(o && !a.includes(t)) ||
								((t = c[e]),
								ae(s, l, r, t.originalHandler, t.delegationSelector));
						});
					}
				},
				trigger(e, t, n) {
		...
		var ue = (n, i = "hide") => {
			...
			const r = n.NAME;
			v.on(document, e, `[data-bs-dismiss="${r}"]`, function (e) {
				if (
					(["A", "AREA"].includes(this.tagName) && e.preventDefault(), !a(this))
				) {
					e = o(this) || this.closest("." + r);
		...
		v.on(document, "click.bs.button.data-api", fe, (e) => {
			e.preventDefault();
			e = e.target.closest(fe);
			const t = he.getOrCreateInstance(e);
			t.toggle();
		}),
			e(he);
		const u = {
		...
		class y extends t {
			...
			to(e) {
				this._activeElement = f.findOne(Ee, this._element);
			...
			_triggerSlideEvent(e, t) {
				var n = this._getItemIndex(e),
					i = this._getItemIndex(f.findOne(Ee, this._element));
			...
			_updateInterval() {
				const e = this._activeElement || f.findOne(Ee, this._element);
				var t;
				e &&
			...
			_slide(e, t) {
				...
				const n = f.findOne(Ee, this._element),
					i = this._getItemIndex(n),
					r = t || this._getItemByOrder(e, n),
				...
				if (r && r.classList.contains(m)) this._isSliding = !1;
				else if (!this._isSliding) {
					s = this._triggerSlideEvent(r, c);
					if (!s.defaultPrevented && n && r) {
						(this._isSliding = !0),
							t && this.pause(),
		...
		v.on(
			...
			v.on(window, "load.bs.carousel.data-api", () => {
				var n = f.find('[data-bs-ride="carousel"]');
		...
		class Pe extends t {
			...
			show() {
				if (!this._isTransitioning && !this._isShown()) {
					...
					if (this._config.parent) {
						const r = f.find(Oe, this._config.parent);
						e = f
					...
					if (e.length) {
						var n = e.find((e) => i !== e);
						if ((t = n ? Pe.getInstance(n) : null) && t._isTransitioning)
							return;
					}
					n = v.trigger(this._element, "show.bs.collapse");
					if (!n.defaultPrevented) {
						e.forEach((e) => {
							i !== e && Pe.getOrCreateInstance(e, { toggle: !1 }).hide(),
								t || ce.set(e, Ce, null);
						});
						...
						this._queueCallback(
							() => {
								(this._isTransitioning = !1),
									...
									this._element.classList.add(je, Se),
					...
					if (!e.defaultPrevented) {
						var e = this._getDimension(),
							t =
								...
								d(this._element),
								this._element.classList.add(Ne),
								this._element.classList.remove(je, Se),
			...
			_getConfig(e) {
				return (
					((e = { ...Ae, ...u.getDataAttributes(this._element), ...e }).toggle =
						Boolean(e.toggle)),
					(e.parent = i(e.parent)),
					n(Te, e, ke),
					e
			...
			_initializeChildren() {
				if (this._config.parent) {
					const t = f.find(Oe, this._config.parent);
					f.find(Le, this._config.parent)
			...
			_addAriaAndCollapsedClass(e, t) {
				e.length &&
					e.forEach((e) => {
						t ? e.classList.remove(De) : e.classList.add(De),
		...
		var k = "top",
			...
			Fe = He.reduce(function (e, t) {
				return e.concat([t + "-" + D, t + "-" + Me]);
			}, []),
			$e = [].concat(He, [Ie]).reduce(function (e, t) {
				return e.concat([t, t + "-" + D, t + "-" + Me]);
			}, []),
			ve = "beforeRead",
			Qe = "afterRead",
			ze = "beforeMain",
			...
			Xe = "beforeWrite",
			Ve = "afterWrite",
			Ye = [ve, "read", Qe, ze, "main", Ue, Xe, "write", Ve];
		function b(e) {
		...
		function T(e) {
			return (
				(Ke(e) ? e.ownerDocument : e.document) || window.document
			).documentElement;
		}
		function tt(e) {
			return "html" === b(e)
				? e
				: e.assignedSlot || e.parentNode || (Ge(e) ? e.host : null) || T(e);
		}
		function nt(e) {
		...
		var A = {
			...
			fn: function (e) {
				var t,
					...
					c = rt((u = O(o.placement))),
					u = 0 <= [N, j].indexOf(u) ? "height" : "width";
				a &&
					l &&
					((e = e.padding),
					(n = o),
			...
			var t,
				...
				f =
					!0 === e
						? ((f = (h = l).x),
						  ...
						  { x: st(st(f * p) / p) || 0, y: st(st(h * p) / p) || 0 })
						: "function" == typeof e
						? e(l)
						: l,
				h = f.x,
				...
				r =
					(d &&
						...
						(n = "clientWidth"),
						(t = it(r)) === _(r) &&
							"static" !== E((t = T(r))).position &&
							"absolute" === c &&
							((i = "scrollHeight"), (n = "scrollWidth")),
						(s !== k && ((s !== N && s !== j) || a !== Me)) ||
							((v = S), (e = (e - (t[i] - o.height)) * (u ? 1 : -1))),
						(s !== N && ((s !== k && s !== S) || a !== Me)) ||
							((m = j), (p = (p - (t[n] - o.width)) * (u ? 1 : -1)))),
					Object.assign({ position: c }, d && ft));
			return u
				? Object.assign(
						{},
						r,
		...
		var mt = {
				...
				effect: function (e) {
					...
					return (
						...
						o && s.addEventListener("resize", n.update, gt),
						function () {
							r &&
								a.forEach(function (e) {
									e.removeEventListener("scroll", n.update, gt);
								}),
								o && s.removeEventListener("resize", n.update, gt);
						}
					);
				},
				data: {},
		...
		function At(e, t) {
			return t === Re
				? Ct(
						...
						{ width: o, height: r, x: s + xt(n), y: a })
				  )
				: w(t)
				? (((o = Je((i = t))).top = o.top + i.clientTop),
				...
				: Ct(
						...
						(n = -n.scrollTop),
						"rtl" === E(a || s).direction &&
							(r += C(s.clientWidth, a ? a.clientWidth : 0) - t),
						{ width: t, height: e, x: r, y: n })
				  );
			var n, i, r, o, s, a;
		}
		function kt(n, e, t) {
			var i,
				r =
					"clippingParents" === e
						? ((o = Tt(tt((r = n)))),
						  Ke(
								(i =
									0 <= ["absolute", "fixed"].indexOf(E(r).position) && w(r)
										? it(r)
										: r)
						  )
								? o.filter(function (e) {
										return Ke(e) && et(e, i) && "body" !== b(e);
								  })
								: [])
						: [].concat(e),
				o = [].concat(r, [t]),
				...
				t = o.reduce(function (e, t) {
					...
					return (
						(e.top = C(t.top, e.top)),
						(e.right = ot(t.right, e.right)),
						(e.bottom = ot(t.bottom, e.bottom)),
		...
		function jt(e, t) {
			var i,
				...
				a = kt(Ke(a) ? a : a.contextElement || T(e.elements.popper), r, o),
				r = Je(e.elements.reference),
				o = St({
					reference: r,
					element: l,
					strategy: "absolute",
								...
								return e.concat(
									O(t) === Ie
										? ((n = d),
										  ...
										  (s = e.padding),
										  (a = e.flipVariations),
										  (l = void 0 === (e = e.allowedAutoPlacements) ? $e : e),
										  (c = dt(i)),
										  (e = c
												? a
													? Fe
		...
		function Ot(t) {
			return [k, j, S, N].some(function (e) {
				return 0 <= t[e];
			});
		}
		var Lt = {
			...
			fn: function (e) {
				var t = e.state,
					...
					o = jt(t, { elementContext: "reference" }),
								...
								(t =
									(n =
										"function" == typeof i
											...
											: i)[0] || 0),
								(i = (n[1] || 0) * o),
								0 <= [N, j].indexOf(r) ? { x: i, y: t } : { x: t, y: i })),
							e
						);
					}, {}),
					n = (i = t[s.placement]).x,
			...
			fn: function (e) {
				...
				_ &&
					((f || h) &&
						...
						(l = l[a]),
						(a = at(0, w[o], x[o])),
						(x = m ? w[o] / 2 - s - a - c - d : r - a - c - d),
						(r = m ? -w[o] / 2 + s + a + l + d : v + a + l + d),
						...
						(s = _[g] + r - w),
						f &&
							((v = at(y ? ot(n, o) : n, t, y ? C(i, s) : i)),
							(_[g] = v),
							(E[g] = v - t)),
						h &&
							((l = (a = _[b]) + p["x" === g ? k : N]),
							(d = a - p["x" === g ? S : j]),
							(c = at(y ? ot(l, o) : l, a, y ? C(d, s) : d)),
							(_[b] = c),
							(E[b] = c - a))),
					(u.modifiersData[e] = E));
			},
			...
			return (
				(!i && n) ||
					...
					w(t)
						...
						: r && (s.x = xt(r))),
				{
					x: o.left + e.scrollLeft - s.x,
					y: o.top + e.scrollTop - s.y,
					width: o.width,
					height: o.height,
				}
			);
		...
		var Ft = Wt({ defaultModifiers: [mt, It, pt, x, Pt, Nt, Ht, A, Lt] });
		const $t = Object.freeze({
				...
				createPopperBase: Wt(),
				createPopper: Ft,
				createPopperLite: Wt({ defaultModifiers: [mt, It, pt, x] }),
				top: k,
				bottom: S,
				right: j,
				left: N,
			...
			Qt = "dropdown";
		(ve = ".bs.dropdown"), (Qe = ".data-api");
		const zt = "Escape",
			Ut = "ArrowUp",
			Xt = "ArrowDown",
			Vt = new RegExp(Ut + `|${Xt}|` + zt);
		(ze = "click" + ve + Qe), (Ue = "keydown" + ve + Qe);
		const Yt = "show",
			Kt = '[data-bs-toggle="dropdown"]',
			Gt = ".dropdown-menu",
			Jt = r() ? "top-end" : "top-start",
			Zt = r() ? "top-start" : "top-end",
			en = r() ? "bottom-end" : "bottom-start",
			tn = r() ? "bottom-start" : "bottom-end",
			nn = r() ? "left-start" : "right-start",
			rn = r() ? "right-start" : "left-start",
			on = {
				offset: [0, 2],
		...
		class L extends t {
			...
			show() {
				if (!a(this._element) && !this._isShown(this._menu)) {
					...
					if (!t.defaultPrevented) {
						const n = L.getParentFromElement(this._element);
						this._inNavbar
			...
			_getConfig(e) {
				if (
					...
					n(Qt, e, this.constructor.DefaultType),
			...
			_getMenuElement() {
				return f.next(this._element, Gt)[0];
			}
			_getPlacement() {
			...
			_selectMenuItem({ key: e, target: t }) {
				const n = f
					...
					.filter(W);
				n.length && X(n, t, e === Xt, !n.includes(t)).focus();
			}
			static jQueryInterface(t) {
				return this.each(function () {
				...
				if (
					/input|textarea/i.test(e.target.tagName)
						? !(
								"Space" === e.key ||
								(e.key !== zt &&
									((e.key !== Xt && e.key !== Ut) || e.target.closest(Gt)))
						  )
						: Vt.test(e.key)
				) {
					var t = this.classList.contains(Yt);
					if (
						(t || e.key !== zt) &&
						(e.preventDefault(), e.stopPropagation(), !a(this))
					) {
						var n = this.matches(Kt) ? this : f.prev(this, Kt)[0];
						const i = L.getOrCreateInstance(n);
						if (e.key !== zt)
							return e.key === Ut || e.key === Xt
		...
		v.on(document, Ue, Kt, L.dataApiKeydownHandler),
			v.on(document, Ue, Gt, L.dataApiKeydownHandler),
			v.on(document, ze, L.clearMenus),
			v.on(document, "keyup.bs.dropdown.data-api", L.clearMenus),
			v.on(document, ze, Kt, function (e) {
		...
		class cn {
			...
			_applyManipulationCallback(e, t) {
				s(e) ? t(e) : f.find(e, this._element).forEach(t);
			}
			isOverflowing() {
		...
		const _n = { backdrop: !0, keyboard: !0, focus: !0 },
			...
			Tn = (P, "resize" + P),
			Cn = "click.dismiss" + P,
			An = "keydown.dismiss" + P,
			kn = (P, "mousedown.dismiss" + P);
		P;
		const Sn = "modal-open",
			jn = "modal-static";
		class Nn extends t {
			...
			hide() {
				...
				!this._isShown ||
					...
					v.off(this._dialog, kn),
					this._queueCallback(() => this._hideModal(), this._element, e));
			}
			dispose() {
				[window, this._dialog].forEach((e) => v.off(e, P)),
			...
			_showElement(e) {
				...
				const n = f.findOne(".modal-body", this._dialog);
		...
		const On = { backdrop: !0, keyboard: !0, scroll: !1 },
			Ln = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" },
			Pn = ".offcanvas.show",
			In = "hidden" + Xe;
		class I extends t {
			constructor(e, t) {
		...
		v.on(
			...
			v.on(window, "load.bs.offcanvas.data-api", () =>
				f.find(Pn).forEach((e) => I.getOrCreateInstance(e).show())
			),
			ue(I),
			e(I);
		const Hn = new Set([
		...
		class Zn extends t {
			...
			dispose() {
				clearTimeout(this._timeout),
					v.off(this._element.closest(".modal"), Kn, this._hideModalHandler),
			...
			_setListeners() {
				...
				e.forEach((e) => {
					...
					v.on(this._element.closest(".modal"), Kn, this._hideModalHandler),
					this._config.selector
						? (this._config = {
								...this._config,
								trigger: "manual",
			...
			_enter(e, t) {
				(t = this._initializeOnDelegatedTarget(e, t)),
					...
					t.getTipElement().classList.contains(Xn) || t._hoverState === Vn
						? (t._hoverState = Vn)
			...
			_leave(e, t) {
				(t = this._initializeOnDelegatedTarget(e, t)),
					e &&
						(t._activeTrigger["focusout" === e.type ? Jn : Gn] =
		...
		class pi extends t {
			...
			refresh() {
				var e =
					this._scrollElement === this._scrollElement.window ? "offset" : hi;
				const i = "auto" === this._config.method ? e : this._config.method,
					...
					t =
						...
						f.find(fi, this._config.target));
				t.map((e) => {
					e = R(e);
					const t = e ? f.findOne(e) : null;
					if (t) {
						var n = t.getBoundingClientRect();
						if (n.width || n.height) return [u[i](t).top + r, e];
					}
					return null;
				})
					.filter((e) => e)
			...
			dispose() {
				v.off(this._scrollElement, oi), super.dispose();
			}
			_getConfig(e) {
				return (
					((e = {
				...
				n.classList.add(ci),
					n.classList.contains(li)
						...
						: f.parents(n, ".nav, .list-group").forEach((e) => {
								f.prev(e, ui + ", " + di).forEach((e) => e.classList.add(ci)),
									f.prev(e, ".nav-item").forEach((e) => {
										f.children(e, ui).forEach((e) => e.classList.add(ci));
									});
						  }),
		...
		v.on(window, "load.bs.scrollspy.data-api", () => {
			f.find('[data-bs-spy="scroll"]').forEach((e) => new pi(e));
		}),
			e(pi);
		const gi = "active",
			mi = ".active",
		...
		class yi extends t {
			...
			_transitionComplete(e, t, n) {
				if (t) {
					...
					const r = f.findOne(":scope > .dropdown-menu .active", t.parentNode);
				...
				(i = i && "LI" === i.nodeName ? i.parentNode : i) &&
					...
					((t = e.closest(".dropdown")) &&
						f.find(".dropdown-toggle", t).forEach((e) => e.classList.add(gi)),
